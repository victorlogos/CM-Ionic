...
export class ProductsPage {
    ...
    constructor(public iab: InAppBrowser, public toastCtrl: ToastController, public modalCtrl: ModalController, public nav: NavController, public popoverCtrl: PopoverController, public service: CategoryService, params: NavParams, public values: Values, public functions: Functions) {
        this.filter = {};
       ...
       if (!this.values.featuredProducts) {
            this.filter.category = params.data.id;
            this.categoryName = params.data.name;
        ...
        else if (this.values.featuredProducts) {
